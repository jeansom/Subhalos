...
for xi in range(max_loc, len(xsec_test_arr)):
    ...
    if val < -2.71:
        ...
        break
np.savez("lim_fixed_"+str(xsec_inj) + "_" + str(useData) + "_" + str(Nb) + "_" + tag, [xsec_rec, -minuit_min.fval ], ll_arr, d_arr_ebins, i_arr_ebins, p_arr_ebins )
