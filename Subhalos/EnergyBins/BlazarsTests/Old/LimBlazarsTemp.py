...
Nb = 1
SCD_params = np.array([-5.145088814999999, 2.07503614, 1.56190097, 0.924471755, 63.699129415, 0.736722895])
    ...
    for ib in range(len(my_iebins)-1):
        ...
        if PPnoxsec_ebins[ib] != 0:
            minuit_min = iminuit.Minuit(lambda Ab, n1b, n2b, n3b, Fb1b, Fb2b: ll_func( xsec_t, Ab, n1b, n2b, n3b, Fb1b, Fb2b ), 
                                        ...
                                        Ab=0., limit_Ab=(-10, -1), error_Ab=1e-2, n1b=10, limit_n1b=(2.05,20.), error_n1b=1e-2, n2b=0, limit_n2b=(-3,3), error_n2b=1e-2, n3b=1.4, limit_n3b=(-10, .95), error_n3b=1e-2, Fb1b=60, limit_Fb1b=(0,100), error_Fb1b=1e-2, Fb2b=0.5, limit_Fb2b=(0.,1), error_Fb2b=1e-3,
                                        print_level=1)
            minuit_min.migrad()
            ll += (-minuit_min.fval)
