...
#        np.save("/tigress/somalwar/Subhaloes/Subhalos/MC/FixedSCD/subhalo_flux_map_NFW_"+str(sys.argv[1])+"_"+str(my_iebins[ib])+"-"+str(my_iebins[ib+1])+"_"+str(xsec), flux_map) 
        ...
        n.add_non_poiss_model( 'subhalos',
                               ...
                               [[-10, -1],[2.05, 10],[-3, 3], [-3, 3], [-10.0, 1.95], [1, 5000], [0, 1], [0, 1]],
        ...
        scipy_min = minimize( ll, [-6, 10, 0.1, 0.1, 0.1, 0.01, 0.01], method="SLSQP", bounds = [ [-10, -2], [5, 15], [-3,3], [-3,3], [-10, 1.95], [0.01, 1], [0.01, 1] ], options={'ftol':1e-15, 'eps':1e-5, 'maxiter':5000, 'disp':True} )
